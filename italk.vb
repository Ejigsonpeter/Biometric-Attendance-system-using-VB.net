...
#Region " Properties "
        ...
        Public Property TextAlignment As _TextAlignment
            ...
            End Get
            Set(ByVal value As _TextAlignment)
...
#Region " Custom Properties "
        ...
        Public Property ProgressShape As _ProgressShape
            ...
            End Get
            Set(ByVal value As _ProgressShape)
...
#Region " EventArgs "
        ...
        Private Sub AnimationSpeed_Tick(ByVal sender As Object, ByVal e As EventArgs)
...
#End Region
        ...
        Private Function AssignValues(Of X)(ByRef Run As X, ByVal Length As X) As X
            Run = Length
            Return Length
        End Function

        Private Sub SetValue(ByVal StartingFloatPoint As PointF, ByVal Length As Integer, ByVal Angle As Double)
